...
def run_command(command, stream_output=False):
    """
    Run a Linux command with PostgreSQL environment variables set.
    """
    try:
        # Set PostgreSQL environment variables
        env = os.environ.copy()  # Get a copy of the current environment
        env['PGPASSWORD'] = os.environ.get('POSTGRES_PASSWORD', '')
        env['PGHOST'] = os.environ.get('POSTGRES_HOST', '')
        env['PGPORT'] = os.environ.get('POSTGRES_PORT', '')
        env['PGUSER'] = os.environ.get('POSTGRES_USER', '')
        env['PGSSLMODE'] = os.environ.get('POSTGRES_SSL_MODE', 'disable')
